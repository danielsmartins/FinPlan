    ...
    return (
      <div className="bg-white p-5 rounded-xl shadow-sm h-full flex flex-col justify-between">
        ...
        <div className="mt-4 space-y-2 text-sm">
          <div className="flex justify-between"><span className="text-gray-500">{sub1Title}</span><span className="font-medium text-gray-800">{formatCurrency(sub1Value)}</span></div>
          <div className="flex justify-between"><span className="text-gray-500">{sub2Title}</span><span className="font-medium text-gray-800">{formatCurrency(sub2Value)}</span></div>
        </div>
      </div>
    );
}
